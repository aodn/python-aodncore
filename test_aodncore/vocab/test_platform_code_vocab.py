...
class TestPlatformCodeVocab(BaseTestCase):
    ...
    @patch("aodncore.vocab.platform_code_vocab.DEFAULT_PLATFORM_CAT_VOCAB_URL", PLATFORM_CAT_VOCAB_URL)
    def test_altlabels_deprecated(self):
        res = platform_altlabels_per_preflabel(category_name='Vessel', platform_vocab_url=PLATFORM_VOCAB_URL)
        self.assertEqual(res['9VUU'], 'Anro Asia')
