...
class TestPipelineStepsHarvest(BaseTestCase):
    def setUp(self):
        ...
        self._config = LazyConfigManager()
    ...
    def test_validate_file_handling_failure(self):
        ...
        harvester_runner = TalendHarvesterRunner(self.uploader, None, TESTDATA_DIR, self.config, MOCK_LOGGER)
    ...
    def test_get_harvest_runner(self):
        harvester_runner = get_harvester_runner('talend', self.uploader, None, TESTDATA_DIR, None, MOCK_LOGGER)
    ...
    def test_get_harvest_runner_invalid(self):
        with self.assertRaises(InvalidHarvesterError):
            _ = get_harvester_runner('nonexistent_harvester', self.uploader, None, TESTDATA_DIR, None, MOCK_LOGGER)
    ...
    def test_multi_harvester_success(self, mock_execute_talend):
        ...
        harvest_collection = get_harvest_collection()
        multi_harvester_runner = TalendHarvesterRunner(self.uploader, None, TESTDATA_DIR, self.config, MOCK_LOGGER)
