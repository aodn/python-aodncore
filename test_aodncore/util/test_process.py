...
class TestUtilProcess(BaseTestCase):
    ...
    def test_execute_with_stdin(self):
        ...
        process.execute()
        self.assertEqual(stdin_text, process.stdout_text)
    ...
    def test_empty_command(self):
        with assertRaisesRegex(self, SystemCommandFailedError,
    ...
    def test_nonexistent_command(self):
        ...
        with assertRaisesRegex(self, SystemCommandFailedError, ".*OSError: \[Errno 2\] No such file or directory"):
            process.execute()
    ...
    def test_execute_multiple(self):
        ...
        process.execute()
        with assertRaisesRegex(self, SystemCommandFailedError, '.*command has already been executed'):
            process.execute()
